...
export const aboutMeData = {
	name: "Usama Riaz",
	title: "Hello! I'm Usama Riaz",
	body: "I am a Full Stack Web Developer and Artificial Intelligence Engineer with a passion for solving problems with code. I started my journey into the world of Digital Marketing and Eccommerce a few years ago, and since then I've been constantly learning and improving my skills. I'm always looking for opportunities to branch out and explore new technologies.",
	highlightedBody:
		"As a beginner, I'm constantly seeking new challenges and projects to work on. I'm particularly interested in web development, machine learning, Metaverse, and Ambient Computing IoT(Internet of things), and I've completed several personal projects in these areas. I'm always eager to take on new challenges and collaborate with others, and I believe that working on projects is the best way to learn and grow as an AI engineer.",
	body2:
		"When I'm not coding, I enjoy spending time to explore new technologies, learning new things, and Readings Books. I'm a lifelong learner, and I'm always looking for new books, tutorials, and courses to help me improve my skills and knowledge. If you're interested in learning more about my skills and experience, feel free to take a look at my CV. I'd love to hear from you and discuss potential opportunities to collaborate on projects or learn from each other.",
};

export const contactMeText = {
	title: "Hello there! ",
	body: "I am a Full Stack Web Developer and Artificial Intelligence Engineer with a passion for solving complex problems with data. I bring a unique blend of technical and interpersonal skills to the table. I'm always eager to take on new challenges and collaborate with like-minded individuals. If you'd like to get in touch, simply fill out the form below and I'll get back to you as soon as possible. Looking forward to hearing from you!",
};

export const projects = [
	{
		title: "Shared Expense Managment System",
		body1:
